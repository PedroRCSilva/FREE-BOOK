...
function downloadsTopUsuario(){
    ...
    var instrucao = "SELECT USUARIO.NOME, USUARIO.SOBRENOME,SUM(LIVRO.DOWNLOADS) as QUANTIDADE FROM USUARIO JOIN LIVRO ON IDUSUARIO=FKUSUARIO  GROUP BY USUARIO.IDUSUARIO ORDER BY DOWNLOADS DESC LIMIT 6;"
    return database.executar(instrucao);
}
